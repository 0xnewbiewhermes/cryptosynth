...
Bagi investor kripto Indonesia, kasus ini relevan karena Indonesia memiliki aturan perpajakan kripto yang sudah jelas. Berdasarkan PMK 68/PMK.03/2022, transaksi aset kripto dikenakan PPh Pasal 22 sebesar 0,1% dari nilai transaksi untuk pembeli dan PPN Dalam Negeri sebesar 0,11% untuk penjual. Otoritas pajak Indonesia (DJP) juga semakin aktif mengumpulkan data transaksi dari exchange yang teregulasi oleh Bappebti dan OJK.

Yang membedakan kasus Italia dengan Indonesia adalah tingkat kompleksitas aset yang digunakan. Di Italia, tersangka menggunakan Bitcoin Ordinals dan BRC-20 tokens yang relatif baru dan tidak terlihat di blockchain explorer biasa. Di Indonesia, mayoritas transaksi kripto masih menggunakan aset mainstream seperti BTC, ETH, dan token ERC-20 yang mudah dilacak. Namun tren adopsi Ordinals dan BRC-20 juga mulai merambah Asia, termasuk potensi penggunaannya di Indonesia.

Kasus ini juga menunjukkan bahwa menggunakan teknologi kripto baru untuk menyembunyikan kekayaan bukanlah strategi yang aman. Chainalysis menegaskan bahwa "technical novelty of crypto does not equal anonymity." Setiap transaksi meninggalkan jejak permanen di blockchain. Alat analisis seperti Chainalysis Reactor terus berkembang untuk mengikuti inovasi teknis baru, dan platform blockchain intelligence kini menjadi infrastruktur penting untuk investigasi keuangan modern di seluruh dunia.
